...
import illustration1dark from 'assets/images/illustrations/6-dark.webp';
import illustration1 from 'assets/images/illustrations/6-light.webp';
      ...
      <Grid container spacing={2}>
        <Grid>
          <ButtonBase sx={{ width: 128, height: 128 }}>
            <Image
              alt="complex"
              src={{ light: illustration1, dark: illustration1dark }}
  ...
  return (
    ...
    >
      ...
      <DocSection title="Complex Grid">
        <DocCard code={complexGrid} scope={{ illustration1, illustration1dark, Image }} noInline />
      </DocSection>
    </DocPageLayout>
  );
};
