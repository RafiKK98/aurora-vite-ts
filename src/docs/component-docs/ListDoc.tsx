            ...
            <Grid size={{ xs: 12, sm: 6, md: 12, lg: 6 }}>
              ...
              <Box sx={{ bgcolor: 'background.elevation1' }}>
                <List dense={dense}>
                  <ListItem>
                    <ListItemAvatar>
                      <Avatar alt="James Smith" src={avatar1} />
                    </ListItemAvatar>
                    <ListItemText
                      primary="Single-line item"
                      secondary={secondary ? 'Secondary text' : null}
                  ...
                  <ListItem>
                    <ListItemAvatar>
                      <Avatar alt="James Smith" src={avatar2} />
                    </ListItemAvatar>
                    <ListItemText
                      primary="Single-line item"
                      secondary={secondary ? 'Secondary text' : null}
                  ...
                  <ListItem>
                    <ListItemAvatar>
                      <Avatar alt="James Smith" src={avatar3} />
                    </ListItemAvatar>
                    <ListItemText
                      primary="Single-line item"
                      secondary={secondary ? 'Secondary text' : null}
        ...
        <List>
          ...
          >
            <ListItemButton selected={selectedIndex === 0} onClick={() => handleListItemClick(0)}>
              <ListItemAvatar>
                <Avatar src={avatar3} alt="Morgan Bennett" />
              </ListItemAvatar>
          ...
          >
            <ListItemButton selected={selectedIndex === 1} onClick={() => handleListItemClick(1)}>
              <ListItemAvatar>
                <Avatar src={avatar1} alt="Jordan Sinclair" />
              </ListItemAvatar>
          ...
          >
            <ListItemButton selected={selectedIndex === 2} onClick={() => handleListItemClick(2)}>
              <ListItemAvatar>
                <Avatar src={avatar2} alt="Avery Mitchell" />
              </ListItemAvatar>
...
const CheckboxListComparison = () => {
  ...
  const items = [
    { id: 0, name: "Morgan Bennett", avatar: '/static/images/avatar/1.jpg' },
    { id: 1, name: "Jordan Sinclair", avatar: '/static/images/avatar/2.jpg' },
    { id: 2, name: "Avery Mitchell", avatar: '/static/images/avatar/3.jpg' },
  ];
  ...
  return (
    ...
    >
      ...
      <DocSection title="Interactive List">
        <DocCard code={interactiveListCode} scope={{ avatar1, avatar2, avatar3 }} noInline />
      </DocSection>
      <DocSection title="Selected ListItem">
        <DocCard code={selectedListCode} scope={{ avatar1, avatar2, avatar3 }} noInline />
      </DocSection>
      <DocSection
      ...
      >
        <DocCard code={alignListItemsCode} scope={{ avatar1, avatar2, avatar3 }} noInline />
      </DocSection>
