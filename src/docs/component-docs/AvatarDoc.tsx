...
import person1 from 'assets/images/avatar/avatar_1.webp';
import person2 from 'assets/images/avatar/avatar_2.webp';
...
const imageAvatarCode = `<Stack spacing={1}>
  ...
  <Avatar alt="Travis Howard" src={person3} />
  <Avatar alt="Sophia Davis" src={person4} />
</Stack>`;
...
const sizesCode = `<Stack spacing={1}>
  <Avatar alt="Remy Sharp" src={person3} sx={{ width: 24, height: 24 }} />
  <Avatar alt="Remy Sharp" src={person3} sx={{ width: 32, height: 32 }} />
...
const groupedAvatarCode = `<Stack spacing={1}>
  ...
  >
    <Tooltip title="James Smith">
      <Avatar alt="James Smith" src={person1} />
    </Tooltip>
    <Tooltip title="Sophia Davis">
      <Avatar alt="Sophia Davis" src={person2} />
    </Tooltip>
    <Tooltip title="Ethan Johnson">
      <Avatar alt="Ethan Johnson" src={person3} />
    </Tooltip>
    <Tooltip title="John Doe">
      <Avatar alt="John Doe" src={person4} />
    </Tooltip>
...
const BadgeAvatars = () => {
  return (
    <Stack spacing={2}>
      ...
      >
        <Avatar alt="Travis Howard" src={person4} />
      </Badge>
    </Stack>
  );
};
  ...
  return (
    ...
    >
      <DocSection title="Image Avatar">
        <DocCard code={imageAvatarCode} scope={{ person1, person2, person3, person4 }} />
      </DocSection>
      ...
      >
        <DocCard code={variantCode} scope={{ person3 }} />
      </DocSection>
      <DocSection
        title="Sizes"
        descriptionEl={
      ...
      >
        <DocCard code={sizesCode} scope={{ person3 }} />
      </DocSection>
      <DocSection
        title="Fallbacks"
        descriptionEl={
      ...
      >
        ...
        <DocNestedSection id="custom-surplus" title="Custom Surplus">
          ...
          <DocCard code={surplusAvatarCode} scope={{ person1, person2, person3, person4 }} />
        </DocNestedSection>
      </DocSection>
      <DocSection
        title="With Badge"
      ...
      >
        <DocCard
          code={badgeAvatarCode}
          scope={{ person1, person2, person3, person4, Image }}
          noInline
        />
      </DocSection>
    </DocPageLayout>
