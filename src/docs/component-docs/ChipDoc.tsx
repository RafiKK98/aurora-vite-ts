...
const avatarChipsCode = ` <Stack direction="column" spacing={1}>
  <Stack spacing={1} sx={{ flexWrap: 'wrap' }}>
    ...
    <Chip
      avatar={<Avatar alt="Natacha" src={avatar5} />}
      label="Avatar"
      variant="outlined"
      color="primary"
    />
    <Chip
      avatar={<Avatar alt="Elly" src={avatar11} />}
      label="Avatar"
      variant="filled"
      color="primary"
    />
    ...
    >
      ...
      <DocSection title="Chip adornments">
        <DocNestedSection title="Avatar chip" id={kebabCase('Avatar chip')}>
          ...
          <DocCard code={avatarChipsCode} scope={{ avatar5, avatar11 }} sx={{ mb: 4 }} />
        </DocNestedSection>
        ...
        <DocNestedSection title="Icon chip" id={kebabCase('Icon chip')}>
          ...
          <DocCard code={iconChipsCode} scope={{ avatar5 }} />
        </DocNestedSection>
      </DocSection>
      <DocSection
        title="Chip Sizes"
