...
import crabBeach from 'assets/images/docs/lightbox/crab-beach.webp';
import flamingo from 'assets/images/docs/lightbox/flamingo.webp';
import lastNightTwoWeekStayHawaii from 'assets/images/docs/lightbox/last-night-two-week-stay-hawaii.webp';
import miamiBeach from 'assets/images/docs/lightbox/miami-beach.webp';
import puppyInSunglasses from 'assets/images/docs/lightbox/puppy-in-sunglasses.webp';
import rayBanSunglasses from 'assets/images/docs/lightbox/rayban-sunglasses.webp';
import starfish from 'assets/images/docs/lightbox/starfish-on-a-sand-beach.webp';
import sunsetOnKauai from 'assets/images/docs/lightbox/sunset-on-kauai.webp';
...
const BasicExample = () => {
  ...
  const slides = [
    ...
    {
      src: lastNightTwoWeekStayHawaii,
      width: 3840,
      height: 2553,
