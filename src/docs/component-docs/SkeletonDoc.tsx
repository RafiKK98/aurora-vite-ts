...
import cardImage from 'assets/images/ecommerce/banners/banner_1.webp';
import productImage3 from 'assets/images/ecommerce/products/product_6.webp';
import productImage2 from 'assets/images/ecommerce/products/product_7.webp';
import productImage1 from 'assets/images/ecommerce/products/product_8.webp';
      ...
      >
        ...
        <DocNestedSection title="Pulsate Animation Example" id="pulsate-animation-example">
          <DocCard
            ...
            scope={{ Image, productImage2, productImage3, productImage1 }}
            noInline
            sx={{ my: 3 }}
          />
        </DocNestedSection>
        <DocNestedSection title="Wave Animation Example" id="wave-animation-example">
          ...
          <DocCard code={animatedWaveSkeletonCode} scope={{ cardImage }} noInline />
        </DocNestedSection>
      </DocSection>
