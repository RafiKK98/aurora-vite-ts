...
import categoryImage from 'assets/images/ecommerce/categories/category_12.webp';
import bannerImage from 'assets/images/ecommerce/gallery/gallery_3.webp';
import productImage from 'assets/images/ecommerce/products/product_14.webp';
  ...
  return (
    ...
    >
      ...
      <DocSection title="Complex Interaction">
        <DocCard code={complexCardCode} scope={{ productImage }} noInline />
      </DocSection>
      <DocSection
        title="Media"
        descriptionEl={
      ...
      >
        <DocCard code={mediaCardCode} scope={{ bannerImage }} />
      </DocSection>
      <DocSection title="Card Actions">
        <DocCard code={actionCardCode} scope={{ bannerImage }} />
      </DocSection>
      <DocSection
        title="UI Control"
      ...
      >
        <DocCard code={controlledCardCode} scope={{ categoryImage }} />
      </DocSection>
    </DocPageLayout>
  );
};
