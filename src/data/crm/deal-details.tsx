...
import akaiNamida from 'assets/audio/Akai_Namida_instrumental.mp3';
import triangle from 'assets/audio/Triangle_instrumental.mp3';
...
import auroraLogo from 'assets/images/crm/deal-details/aurora-logo.webp';
import logo from 'assets/images/crm/deal-details/logo.webp';
import onesuitImage from 'assets/images/crm/deal-details/onesuite-img.webp';
import pugImage from 'assets/images/crm/deal-details/pug-img.webp';
...
export const dealInformation: DealInfoItem[] = [
  ...
  },
  {
    ...
    value: (
      <Chip
        label="Gerard P."
        avatar={<Avatar src={avatar7} sx={{ width: 16, height: 16 }} />}
        variant="soft"
      />
    ),
    background: false,
  ...
  },
  {
    ...
    value: (
      <Chip
        label="Isaac N."
        avatar={<Avatar src={avatar11} sx={{ width: 16, height: 16 }} />}
        variant="soft"
      />
    ),
    background: false,
...
export const assignedToData: AssignedToData[] = [
  { type: 'Deal Owner', people: [{ id: 1, name: 'Gerard P.', avatar: avatar1, editable: true }] },
  {
    type: 'Collaborator',
    people: [{ id: 2, name: 'Muzan K.', avatar: avatar14, editable: false }],
  },
  {
    type: 'Follower',
    people: [
      { id: 3, name: 'Haddock. C', avatar: avatar4, editable: false },
      { id: 4, name: 'K. Naan', avatar: avatar12, editable: false },
    ],
  },
];
...
export const associatedContactData: AssociatedContactInfo[] = [
  {
    ...
    contactInfo: {
      ...
      contactOwner: [{ id: 1, name: 'Gerard P.', avatar: avatar7 }],
    },
  },
];
...
export const emailData: EmailData[] = [
  ...
  },
  {
    ...
    attachment: [{ src: onesuitImage, name: 'screenshot.jpg', size: '16.2kb' }],
  },
  {
    id: generateUniqueId(),
    name: 'Tsamina Mina',
...
const notes: Note[] = [
  {
    ...
    author: { avatar: avatar5, name: 'Olivia Carter' },
    createdAt: dayjs()
      .subtract(1, 'month')
      .subtract(4, 'day')
      .subtract(5, 'hour')
  ...
  },
  {
    id: generateUniqueId(),
    title: 'Feedback on trial',
    author: { avatar: avatar4, name: 'James Wilson' },
    createdAt: dayjs()
      .subtract(1, 'month')
      .subtract(4, 'day')
      .subtract(6, 'hour')
  ...
  },
  {
    id: generateUniqueId(),
    title: 'Feedback on trial',
    author: { avatar: avatar3, name: 'Lucas Taylor' },
    createdAt: dayjs()
      .subtract(1, 'month')
      .subtract(4, 'day')
      .subtract(2, 'hour')
  ...
  },
  {
    id: generateUniqueId(),
    title: 'Feedback on trial',
    author: { avatar: avatar7, name: 'Gerard P.' },
    createdAt: dayjs()
      .subtract(1, 'month')
      .subtract(4, 'day')
      .subtract(11, 'hour')
