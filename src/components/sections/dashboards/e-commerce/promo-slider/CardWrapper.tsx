...
import bgIllustration from 'assets/images/illustrations/bg-Illustration.webp';
    ...
    <Box
      sx={(theme) => ({
        background:
          mode === 'light'
            ? `
           url(${bgIllustration}) no-repeat center 100% / cover,
           linear-gradient(
             0deg,
           ...
           linear-gradient(
            ...
            : `
           url(${bgIllustration}) no-repeat center 65% / cover,
           linear-gradient(
             0deg,
             ${cssVarRgba(theme.vars.palette.chGreen['950Channel'], 0.02)},
             ${cssVarRgba(theme.vars.palette.chGreen['950Channel'], 0.02)}
