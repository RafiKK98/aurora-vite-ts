...
import ssDark from 'assets/images/sections/misc/landing/hero/hero-img-dark.webp';
import ss from 'assets/images/sections/misc/landing/hero/hero-img.webp';
...
const OurMission = ({ sx }: { sx?: SxProps }) => {
  ...
  return (
    ...
    >
      <Container maxWidth={false} sx={{ maxWidth: 1000, px: { xs: 0 }, py: 8 }}>
        <Grid container>
          <Grid size={6} sx={{ py: 5, display: { xs: 'none', md: 'block' } }}>
            <Box
              sx={{
                ...
                background: `url(${isDark ? ssDark : ss})`,
