          ...
          >
            <Box sx={{ mb: 4 }}>
              ...
              <Typography variant="subtitle2" fontWeight={400} sx={{ maxWidth: 600, mx: 'auto' }}>
                Aurora, an intuitive admin dashboard designed for seamless management, is celebrated
                for its user-friendly interface, powerful analytics, and a community that fosters
                collaboration and growth.
              </Typography>
            </Box>

            <Grid container spacing={1} sx={{ mb: { xs: 4, sm: 0, md: 4 } }}>
              {stats.map((stat) => (
