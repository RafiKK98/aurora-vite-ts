...
import codeImgDark from 'assets/images/landing/examples/5-dark.webp';
import codeImg from 'assets/images/landing/examples/5.webp';
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image src={{ light: codeImg, dark: codeImgDark }} sx={{ width: 1, display: 'block' }} />
        </Box>
      </Stack>
    </Box>
  );
